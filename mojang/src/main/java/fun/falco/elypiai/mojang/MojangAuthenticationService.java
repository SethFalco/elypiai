...
import fun.falco.elypiai.mojang.forms.AuthenticateForm;
import fun.falco.elypiai.mojang.forms.RefreshForm;
import fun.falco.elypiai.mojang.models.AuthenticatedUser;
import fun.falco.elypiai.mojang.models.Authorizable;
